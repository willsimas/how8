                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [Text('Farmácia Popular', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)), Text('Localização:', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)), Text('0KM - Próximo ao ...', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14))],
                      ),
                    ),
                  ],
                ),
